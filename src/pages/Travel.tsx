          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <AccordionItem value="faq" className="rounded-lg border-none">
                <AccordionTrigger className="text-2xl font-semibold hover:no-underline text-center justify-center px-6 py-0 rounded-t-lg [&>svg]:ml-8" style={{ color: '#001540', backgroundColor: '#9ABDDC' }}>
                  FAQ
                </AccordionTrigger>
                <AccordionContent className="text-lg pt-4 space-y-4 px-6 pb-0 rounded-b-lg" style={{ color: '#001540', opacity: 0.8, backgroundColor: '#f8f9fa' }}>
                  <div>
